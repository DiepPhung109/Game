 ...
 * and open the template in the editor.
 */
package gm1942.GameObject;

import gm1942.GameEvents;
import gm1942.Gm1942;
...
public class MyPlane2 extends GameObject implements Observer {
    ...
    public void update(Observable obj, Object arg) {
        ...
        if (vm.getIsAlive2()) {
            if (ge.getType() == 1) {
                ...
                if (msg.equals("explosionP2") || msg.equals("explosionE3")) {

                    System.out.println("P2 Bullet hits Enemy");
                    vm.addScoreP2(10);
                }
                
            } else if (ge.getType() == 3) {
                String msg = (String) ge.getEvent();
                if (msg.equals("explosionE2") || msg.equals("explosionE4")) {
                    System.out.println("Enemy hits P2");
                    int hp = getHp();
                    hp--;
                    if (hp == 8) {
                        this.life--;
